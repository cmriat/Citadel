...
- [x] 4 种检测类型：
  ...
  - 关节有效性（检测静止关节）
  - 视频有效性（检测静止画面）
- [x] JSON + Markdown 双格式报告
- [x] 注册 `pixi run filter` 命令
- [ ] 阈值调优和验证
- [ ] 更多边界情况处理
...
### 进行中 🔄
- **阶段2.11**: 数据质量与转换优化 → v0.2.5 (WIP: 质量过滤工具待完善)
...
- 🔄 **2026-01-15**: 阶段2.11 进行中 - 数据质量与转换优化
...
**更新频率**: 每完成一个子任务更新一次
**最后更新**: 2026-01-15 (阶段2.11 数据质量与转换优化进行中)
